...
public class TaskDBHelper extends SQLiteOpenHelper {
    ...
    public boolean insertTask  (String task, String dateStr, String description)
    {
        Date date;
    ...
    public boolean updateTask (String id, String task, String dateStr, String description)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
